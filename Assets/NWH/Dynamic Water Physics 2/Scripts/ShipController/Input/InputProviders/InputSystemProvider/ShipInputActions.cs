...
//     version 1.4.4
//     from Assets/Dynamic Water Physics 2/Scripts/ShipController/Input/InputProviders/InputSystemProvider/ShipInputActions.inputactions
//
        ...
        public struct ShipControlsActions
        {
            ...
            public void SetCallbacks(IShipControlsActions instance)
            {
                if (m_Wrapper.m_ShipControlsActionsCallbackInterface != null)
                {
                    ...
                    @RotateSail.started -= m_Wrapper.m_ShipControlsActionsCallbackInterface.OnRotateSail;
                    @RotateSail.performed -= m_Wrapper.m_ShipControlsActionsCallbackInterface.OnRotateSail;
                    @RotateSail.canceled -= m_Wrapper.m_ShipControlsActionsCallbackInterface.OnRotateSail;
                }
